...
class accounts:
    def __init__(self, fileName="accounts.txt"):
        with open('accounts.txt') as f:
            self.accounts = f.read().splitlines()
...
#         self.name       = name
#         self.url        = instagramAPI.url
#         self.payload    = instagramAPI.payload
#         self.headers    = instagramAPI.headers
...
#     def _runResponse(self):
#         self.response   = requests.request("GET", url, data=payload, headers=headers, params=querystring)
